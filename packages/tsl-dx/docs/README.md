...
| [noUnsafeAs](variables/noUnsafeAs.md) | Rule to disallow type assertions via `as` except for `as const` and `as unknown`. |
| [nullish](variables/nullish.md) | Rule to enforce the use of loose equality for nullish checks. |
